...
(function($)
{
    ...
    var MagicSuggest = function(element, options)
    {
        ...
        var defaults = {
             ...
             */
            emptyText: function() {
                return cfg.editable ? 'Digite ou click aqui' : 'Click aqui';
            },
            ...
            maxEntryRenderer: function(v) {
                return 'Por favor reduza a quantidade de entrada em ' + v + ' caracteres' + (v > 1 ? 's':'');
            },
            ...
            minCharsRenderer: function(v) {
                return 'Por favor digite ' + v + ' ou mais caracteres' + (v > 1 ? 's':'');
            },
