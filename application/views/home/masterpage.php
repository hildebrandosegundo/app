...
<body>
   ...
   <div id="Layer3" style="position:absolute;overflow:hidden;text-align:left;left:0px;top:624px;width:100%;min-width:994px;height:161px;z-index:5;" title="">
   </div>
   <div id="container">
      <div id="wb_ContentPlaceHolder2" style="position:absolute;left:0px;top:166px;width:994px;height:458px;text-align:center;z-index:6;">
      </div>
      <div id="Layer1" style="position:absolute;overflow:auto;text-align:center;left:0px;top:0px;width:972px;height:68px;z-index:7;" title="">
         <div id="Layer1_Container" style="width:972px;position:relative;margin-left:auto;margin-right:auto;text-align:left;">
            <div id="wb_Logout1" style="position:absolute;left:855px;top:9px;width:45px;height:45px;z-index:0;">
               <form name="logoutform" method="post" action="<?php echo URL; ?>/masterpage/logout" id="logoutform">
                  <input type="hidden" name="form_name" value="logoutform">
                  <input type="image" name="logout" id="logout" src="<?php echo URL; ?>/public/img/logout.gif" />
               </form>
            </div>
            <div id="wb_Logout2" style="position:absolute;left:905px;top:19px;width:45px;height:23px;z-index:1;">
               <form name="logoutform" method="post" action="<?php echo URL; ?>/masterpage/logout" id="logoutform">
                  <input type="hidden" name="form_name" value="logoutform">
      ...
      <div id="wb_MasterObjects1" style="position:absolute;left:0px;top:84px;width:665px;height:79px;z-index:8;">
         <div id="wb_CssMenu1" style="position:absolute;left:329px;top:3px;width:336px;height:76px;text-align:center;z-index:3;">
            <ul>
               <li class="firstmain"><a href="<?php echo URL; ?>/filtro" target="_self">Inicio</a>
               </li>
