   ...
   <div id="container">
       ...
       <div id="Layer1"
           ...
           <div id="Layer1_Container"
               ...
               <div id="wb_Logout1" style="position:absolute;left:855px;top:9px;width:45px;height:45px;z-index:15;">
                   <form name="logoutform" method="post" action="<?php echo URL; ?>/masterpage_cli/logout" id="logoutform">
       ...
       <div id="wb_MasterObjects1" style="position:absolute;left:0px;top:84px;width:665px;height:79px;z-index:23;">
           <div id="wb_CssMenu1"
               ...
               <ul>
                   <li class="firstmain"><a class="active" href="<?php echo URL; ?>/masterpage_cli" target="_self">Inicio&nbsp;</a></li>
                   <li><a href="<?php echo URL; ?>/listaavaliacao_cli" target="_self">Avaliações</a>
                   </li>
